...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Intro Section -->
    <div class="row">
        <section id="intro" class="col-lg-12 intro-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
    ...
    <div class="row">
        <section id="soins-visage" class="col-lg-12 soins-visage-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div id="maquillage" class="col-lg-3 panel-group">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="maquillagemariee" class="panel-collapse collapse">
                                <div class="panel-body">(Avec 1 essai offert) Atténuer les imperfections, mettre en valeur...
                                    <br> Avec un soin éclat du visage, beauté des mains, pied ou forfait + maquillage
                                </div>
                            </div>
                        </div>
    ...
    <!-- Soins Corps Section -->
    <div class="row">
        <section id="soins-corps" class="col-lg-12 soins-corps-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
    ...
    <!-- Mains & Pieds Section -->
    <div class="row">
        <section id="mains-et-pieds" class="col-lg-12 mains-et-pieds-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
    ...
    <div class="row">
        <section id="epilation-et-maquillage" class="col-lg-12 epilation-et-maquillage-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
